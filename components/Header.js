...
const NavContainer = styled.nav`
  ...
  .active {
    &::after {
      ...
      width: 100%;
      height: 4px;
      border-bottom: 4px solid #53da7c;
      display: block;
      text-align: center;
    }
  }
      ...
      <Left>
        <li>
          <Link href="/products/all">
            <a className={currentRoute === `/products/all` ? 'active' : ''}>
              All
            </a>
          </Link>
        </li>
        <li>
          <Link href="/products/clothes">
            <a className={currentRoute === `/products/clothes` ? 'active' : ''}>
              Clothes
            </a>
          </Link>
        </li>
        <li>
          <Link href="/products/tech">
            <a className={currentRoute === `/products/tech` ? 'active' : ''}>
              Tech
            </a>
          </Link>
        </li>
